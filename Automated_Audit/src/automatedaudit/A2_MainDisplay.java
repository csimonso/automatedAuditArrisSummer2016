 ...
 * @since 2016-08-01
 */
public class A2_MainDisplay extends javax.swing.JFrame {
    ...
    /**
     * Action event method to unpack the tar file once Enter is clicked.
     * @param evt The button action event
     */
    ...
    /**
     * Action event to allow the user to click Enter on keyboard.
    ...
    /**
     * Action event to allows the user to do a manual search for tar file.
     * @param evt The action event
     */
    ...
    public void runProgram() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(A2_MainDisplay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new A2_MainDisplay().setVisible(true);
    ...
    private void openFile(){
        ...
        try {
            ...
            /* Function call to parse all the "Server.info" File */
            server.parseServerFile();
