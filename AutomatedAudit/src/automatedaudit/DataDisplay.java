...
public class DataDisplay extends javax.swing.JFrame {
    ...
    public DataDisplay() {
        ...
        displayPanelENC.setLayout(new BoxLayout(displayPanelENC, Y_AXIS));
    }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(displayPanelTMX, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(displayPanelSEM, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(32, 32, 32))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(displayPanelENC, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DataDisplay().setVisible(false);
            }
        });
    }
    
    public void displayDataTMX(String input){
    ...
    public void displayDataSEM(String input) {
        JLabel newLabel = new JLabel();
        newLabel.setText(input);
    ...
    public void displayDataENC(String input){
        JLabel newLabel = new JLabel();
        newLabel.setText(input);
        displayPanelENC.add(newLabel);
        newLabel.setVisible(true);
    }
